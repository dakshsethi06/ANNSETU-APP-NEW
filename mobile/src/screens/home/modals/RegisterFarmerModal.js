        ...
        <View style={commonStyles.modalContainer}>
          ...
          <ScrollView style={{ padding: 24 }} contentContainerStyle={{ gap: 16 }} keyboardShouldPersistTaps="handled">
            <View style={formStyles.formGroup}>
              <Text style={formStyles.formLabel}>Farmer Name *</Text>
              <TextInput style={formStyles.formInput} placeholder="Enter name (e.g. Dinesh Kumar)" placeholderTextColor={COLORS.textLight} value={newFarmerName} onChangeText={setNewFarmerName} />
            </View>
            ...
            <View style={formStyles.formGroup}>
              ...
              <View style={{ flexDirection: 'row', gap: 8 }}>
                ...
                <TouchableOpacity
                  style={formStyles.outlinedActionBtn}
                  onPress={() => {
                  ...
                  activeOpacity={0.8}
                >
                  <Text style={formStyles.outlinedActionBtnText}>🔄 Gen</Text>
                </TouchableOpacity>
              </View>
            </View>

            <View style={formStyles.formGroup}>
              <Text style={formStyles.formLabel}>State *</Text>
              <TextInput style={formStyles.formInput} placeholder="Enter State" placeholderTextColor={COLORS.textLight} value={newFarmerState} onChangeText={setNewFarmerState} />
            </View>

            <View style={formStyles.formGroup}>
              <Text style={formStyles.formLabel}>Primary Crop *</Text>
              <TextInput style={formInputStyle} placeholder="Enter Primary Crop" placeholderTextColor={COLORS.textLight} value={newFarmerCrop} onChangeText={setNewFarmerCrop} />
            </View>

            <View style={formStyles.formGroup}>
              <Text style={formStyles.formLabel}>Father's Name</Text>
              <TextInput style={formStyles.formInput} placeholder="Enter father's name" placeholderTextColor={COLORS.textLight} value={newFarmerFatherName} onChangeText={setNewFarmerFatherName} />
            </View>

            <View style={formStyles.formGroup}>
              <Text style={formStyles.formLabel}>Phone Number</Text>
              <TextInput style={formStyles.formInput} placeholder="Enter phone number" placeholderTextColor={COLORS.textLight} value={newFarmerPhone} onChangeText={setNewFarmerPhone} keyboardType="numeric" />
            </View>

            <View style={formStyles.formGroup}>
              <Text style={formStyles.formLabel}>Village</Text>
              <TextInput style={formStyles.formInput} placeholder="Enter village" placeholderTextColor={COLORS.textLight} value={newFarmerVillage} onChangeText={setNewFarmerVillage} />
            </View>

            <View style={formStyles.formGroup}>
              <Text style={formStyles.formLabel}>Tehsil</Text>
              <TextInput style={formStyles.formInput} placeholder="Enter tehsil" placeholderTextColor={COLORS.textLight} value={newFarmerTehsil} onChangeText={setNewFarmerTehsil} />
            </View>

            <View style={formStyles.formGroup}>
              <Text style={formStyles.formLabel}>District</Text>
              <TextInput style={formStyles.formInput} placeholder="Enter district" placeholderTextColor={COLORS.textLight} value={newFarmerDistrict} onChangeText={setNewFarmerDistrict} />
            </View>
...
// Fallback style reference since primary crop matches formInput styling
const formInputStyle = formStyles.formInput;
